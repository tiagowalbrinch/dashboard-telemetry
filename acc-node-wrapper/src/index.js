...
class ACCNodeWrapper extends EventEmitter {
    ...
    ReadPhysics() {
        ...
        result.wheelLoad = []
        for (let i = 0; i < 4; i++)
            result.wheelLoad.push(reader.ReadFloat())
        ...
        result.tyreWear = []
        for (let i = 0; i < 4; i++)
            result.tyreWear.push(reader.ReadFloat())

        result.tyreDirtyLevel = []
        for (let i = 0; i < 4; i++)
            result.tyreDirtyLevel.push(reader.ReadFloat())
        ...
        result.camberRAD = []
        for (let i = 0; i < 4; i++)
            result.camberRAD.push(reader.ReadFloat())
        ...
        result.rideHeight = []
        for (let i = 0; i < 2; i++)
            result.rideHeight.push(reader.ReadFloat())
        ...
        result.tyreTempI = []
        for (let i = 0; i < 4; i++)
            result.tyreTempI.push(reader.ReadFloat())

        result.tyreTempM = []
        for (let i = 0; i < 4; i++)
            result.tyreTempM.push(reader.ReadFloat())

        result.tyreTempO = []
        for (let i = 0; i < 4; i++)
            result.tyreTempO.push(reader.ReadFloat())
        ...
        result.mz = []
        for (let i = 0; i < 4; i++)
            result.mz.push(reader.ReadFloat())

        result.fx = []
        for (let i = 0; i < 4; i++)
            result.fx.push(reader.ReadFloat())

        result.fy = []
        for (let i = 0; i < 4; i++)
            result.fy.push(reader.ReadFloat())
        ...
        result.tyreTemp = []
        for (let i = 0; i < 4; i++)
            result.tyreTemp.push(reader.ReadFloat())
    ...
    ReadStatic() {
        ...
        result.suspensionMaxTravel = []
        for (let i = 0; i < 4; i++)
            result.suspensionMaxTravel.push(reader.ReadFloat())

        result.tyreRadius = []
        for (let i = 0; i < 4; i++)
            result.tyreRadius.push(reader.ReadFloat())
        ...
        for (let i = 0; i < 34; i++)
            result.trackConfiguration.push(ReadChar(reader))
        ...
        result.carSkin = []
        for (let i = 0; i < 34; i++)
            result.carSkin.push(ReadChar(reader))
